...
export type CheckIdentifierRequestRole = (typeof CheckIdentifierRequestRole)[keyof typeof CheckIdentifierRequestRole];
export declare const CheckIdentifierRequestRole: {
...
export declare const SendOtpRequestRole: {
    readonly customer: "customer";
    readonly rider: "rider";
    readonly vendor: "vendor";
};
...
export declare const VerifyOtpRequestRole: {
    readonly customer: "customer";
    readonly rider: "rider";
    readonly vendor: "vendor";
};
...
export declare const UpdateOrderStatusRequestStatus: {
    readonly pending: "pending";
    readonly confirmed: "confirmed";
    readonly preparing: "preparing";
    readonly out_for_delivery: "out_for_delivery";
...
export declare const RideStatus: {
    ...
    readonly bargaining: "bargaining";
...
export declare const BookRideRequestType: {
    readonly car: "car";
    readonly bike: "bike";
};
export type BookRideRequestPaymentMethod = (typeof BookRideRequestPaymentMethod)[keyof typeof BookRideRequestPaymentMethod];
export declare const BookRideRequestPaymentMethod: {
    readonly cash: "cash";
    readonly wallet: "wallet";
};
...
export type EstimateFareRequestType = (typeof EstimateFareRequestType)[keyof typeof EstimateFareRequestType];
export declare const EstimateFareRequestType: {
    readonly car: "car";
    readonly bike: "bike";
};
...
export type ReviewSummaryRatingBreakdown = {
    [key: string]: number;
};
...
export declare const KycStatusStatus: {
...
export type CreatePharmacyOrderRequestPaymentMethod = (typeof CreatePharmacyOrderRequestPaymentMethod)[keyof typeof CreatePharmacyOrderRequestPaymentMethod];
export declare const CreatePharmacyOrderRequestPaymentMethod: {
    readonly cod: "cod";
    readonly wallet: "wallet";
};
...
export declare const GetProductsType: {
    readonly mart: "mart";
    readonly food: "food";
};
