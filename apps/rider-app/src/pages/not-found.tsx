  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden page-header-gradient bg-page-bg p-4">
      ...
      <div className="relative z-10 w-full max-w-sm rounded-3xl bg-card p-8 text-center shadow-2xl">
        ...
        <h1 className="mb-2 text-3xl font-extrabold text-foreground">404</h1>
        <p className="mb-6 text-sm leading-relaxed text-muted-foreground">
          {T("notFoundPageDesc")}
        </p>
        <Link
          href="/"
          className="flex h-11 w-full items-center justify-center gap-2 rounded-xl bg-card text-sm font-bold text-card-foreground transition-colors hover:bg-card"
        >
