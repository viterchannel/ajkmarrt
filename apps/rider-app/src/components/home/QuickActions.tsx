...
export function QuickActions() {
  return (
    <div className="grid grid-cols-2 gap-2.5">
      <Link
        href="/earnings"
        className="flex items-center gap-2.5 rounded-2xl border border-border bg-card px-4 py-3 text-white transition-all active:scale-[0.98] active:bg-white/[0.07]"
      >
