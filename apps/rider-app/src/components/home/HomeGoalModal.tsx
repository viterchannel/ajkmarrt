    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/50 backdrop-blur-sm sm:items-center">
      <div className="w-full max-w-sm rounded-t-3xl bg-card p-6 shadow-2xl sm:rounded-3xl">
        ...
        <div className="mb-4">
          ...
          <div className="flex items-center overflow-hidden rounded-2xl border-2 border-border transition-colors focus-within:border-border">
        ...
        <div className="flex gap-2">
          <button
            onClick={onClose}
            className="flex-1 rounded-2xl border border-border py-3 text-sm font-bold text-muted-foreground transition-colors hover:bg-card"
          >
            Cancel
          </button>
          <button
