...
export function getSharedStyles(C: typeof Colors.light) {
  ...
  return {
    sheet, fld, chip, errStyle, btnStyles, primaryBtn, modalHdr,
    empty, notifItem, privRow, secHdr, secCard, otpStyle,
    addrHdr, addrAdd, addrItem, LABEL_OPTS
  };
}
