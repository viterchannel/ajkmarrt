  ...
  return (
    ...
    >
      ...
      <CartSwitchModal
        ...
        targetService={
          type === "food" ? "Food" : type === "pharmacy" ? "Pharmacy" : "Mart"
        }
        currentService={
          cartType === "food"
            ? "Food"
        ...
        onKeepAndBrowse={() => {
          setShowSwitchModal(false);
          keepAndStartNew(type as "mart" | "food" | "pharmacy");
          doAdd();
        }}
      />
        ...
        <View style={styles.productFooter}>
          ...
          {qtyInCart > 0 ? (
            <View style={styles.stepperRow}>
              ...
              >
                <Ionicons
                  name={qtyInCart <= 1 ? "trash-outline" : "remove"}
                  size={13}
                  color={C.danger}
                />
              </TouchableOpacity>
    ...
    return (
      <View style={[styles.container, { paddingTop: insets.top }]}>
        ...
        <ScrollView contentContainerStyle={{ padding: 16, gap: 12 }}>
          ...
          >
            {[0, 1, 2, 3].map((i) => (
              <SkeletonBlock key={i} w={(W - 48) / 2} h={200} r={12} />
            ))}
          </View>
        </ScrollView>
      </View>
              ...
              <View style={styles.vendorTitleRow}>
                ...
                <View
                  style={[
                    styles.openBadge,
                    {
                      backgroundColor: vendor.storeIsOpen
                        ? C.successSoft
                        : C.dangerSoft,
                    },
                  ]}
                >
                  ...
                  <Text
                    style={[
                      styles.openTxt,
                      { color: vendor.storeIsOpen ? C.success : C.danger },
                    ]}
                  >
              ...
              {vendor.storeAnnouncement ? (
                <View style={styles.announcement}>
                  <Ionicons
                    ...
                    color={C.amber}
                  />
                  <Text style={styles.announcementTxt}>
                    {vendor.storeAnnouncement}
                  </Text>
                </View>
              ) : null}
              ...
              >
                ...
                >
                  <Text
                    style={[
                      styles.catChipTxt,
                      !selectedCat && styles.catChipTxtActive,
                    ]}
                  >
                    All
                  </Text>
                ...
                {categories.map((c) => (
                  ...
                  >
                    <Text
                      style={[
                        styles.catChipTxt,
                        selectedCat === c && styles.catChipTxtActive,
                      ]}
                    >
                      {c}
                    </Text>
