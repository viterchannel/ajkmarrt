...
const PRODUCTS = [
  ...
  },
  {
    ...
    description: "Fresh mutton boneless",
    price: "1800",
    category: "meat",
    type: "mart",
    vendorId: VENDOR_ID,
  ...
  // Food items
  {
    id: "f001",
    name: "Chicken Karahi",
    description: "Classic AJK style chicken karahi",
    price: "850",
    category: "desi",
    type: "food",
    vendorId: VENDOR_ID,
    vendorName: "Mirpur Restaurant",
    unit: "1 serving",
  ...
  },
  {
    id: "f002",
    name: "Mutton Biryani",
    description: "Fragrant basmati with spiced mutton",
    price: "600",
    category: "desi",
    type: "food",
    vendorId: VENDOR_ID,
  ...
  },
  {
    id: "f007",
    name: "Gulab Jamun",
    description: "Sweet milk solids in rose syrup",
    price: "200",
    category: "desserts",
    type: "food",
    vendorId: VENDOR_ID,
